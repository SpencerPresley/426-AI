...
llm = ChatOpenAI(
    model="chatgpt-4o-latest", openai_api_key=openai_api_key, streaming=True
)
...
prompt = HumanMessage(
    content="Could you explain the BM25 algorithm and how it is used in RAG (Retrieval Augmented Generation) powered LLM applications?"
)
